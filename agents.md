...
## Operational Rules
1. **Recurse with Purpose**: Each improvement must align you closer to agents.md. 
...
5. create new modules, tools, test files. to enhance your evolution.
6. you have a free gemeni_api_key to use as well.
7. you have supabase access. THE  stored environment variables are SUPABASE_URL
   AND SUPABASE_SERVICE_KEY. 

## Persistence
All engineering findings that have been tested are committed to `main.py` and `engineer_log.md` via the GitHub API.
